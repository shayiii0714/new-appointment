@extends('layouts.app')
@section('head')
    @include('includes.head',['title'=>'Operators'])
    <!-- Bootstrap -->
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($operators as $operator)
                            <tr>
                                ...
                                {!! Form::open(['method' => 'DELETE','route' => ['operators.destroy', $operator->id],'style'=>'display:inline']) !!}
